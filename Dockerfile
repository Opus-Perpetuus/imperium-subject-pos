...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-pos"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-pos"
...
ENV PORT=3000 \
    ...
    KIRLET_TECHNICAL_ID=subject-pos \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
