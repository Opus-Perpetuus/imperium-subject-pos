...
export const pos_order_pages: KirletPageDecl[] = [
  {
    id: "pos.pos-order",
    path: "pos-order",
      ...
      build_feature_shell_page({
        ...
        props: {
          ...
          view: {
            ...
            pluralLabel: "ordenes",
            singularLabel: "ordenes",
            emptyTitle: "Sin registros",
            emptyDescription: "Migra desde Mongo o crea el primero",
          },
          data: {
            list: `${API}/pos-order`,
            record: `${API}/pos-order/:id`,
            create: { method: "POST", action: `${API}/pos-order` },
            update: { method: "PATCH", action: `${API}/pos-order/:id` },
            delete: { method: "DELETE", action: `${API}/pos-order/:id` },
          },
          table: {
            columns: [
          ...
          form: {
            fields: [
              ...
              { name: "date_order", component: "input-date", label: "date order" },
              { name: "amount_total", component: "input-money", label: "amount total" },
              ...
              { name: "price_unit", component: "input-money", label: "price unit" },
