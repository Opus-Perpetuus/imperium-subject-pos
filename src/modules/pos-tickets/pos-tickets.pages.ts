        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "pos_session", component: "input-datalist", label: "pos session", optionsSource: "api://m/subject-pos/pos-session?as=options&limite=1000" },
              { name: "subtotal", component: "input-money", label: "subtotal" },
              { name: "total_paid", component: "input-money", label: "total paid" },
              { name: "change", component: "input-money", label: "change" },
              ...
              { name: "item_id", component: "input-datalist", label: "item id", optionsSource: "api://m/subject-almacen/products?as=options&limite=1000" },
              { name: "quantity", component: "input-number", label: "quantity" },
              { name: "total", component: "input-money", label: "total" },
              { name: "unit_price", component: "input-money", label: "unit price" },
              { name: "price_origin", component: "input-text", label: "price origin" },
              { name: "withdrawal_amount", component: "input-money", label: "withdrawal amount" },
              { name: "withdrawal_reason", component: "input-textarea", label: "withdrawal reason" },
              { name: "withdrawal_signature", component: "input-signature", label: "withdrawal signature" },
            ],
          },
        },
      }),
